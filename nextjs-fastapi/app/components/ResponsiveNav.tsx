...
export function ResponsiveNav() {
  ...
  useEffect(() => {
    ...
    if (token) {
      try {
        ...
        setUser({
          email: payload.sub,
          // Optionally set name and image if available in the payload
  ...
  return (
    <>
      ...
      <nav className="fixed left-0 top-0 bottom-0 hidden md:flex flex-col w-64 bg-background border-r p-4">
        <div className="mb-8">
