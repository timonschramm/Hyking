    ...
    <section className="bg-background-light">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-8 lg:py-20">
        <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start">
          <h1 
            className="font-extrabold text-4xl lg:text-6xl tracking-tight md:-mb-4 text-text"
          >
            Go hiking, get to know new people
          </h1>
          <p 
            className="text-lg leading-relaxed text-text-light"
          >
            The hiking app that helps you find the best hiking trails and connect with other hikers
          </p>
          <Link href="/signup">
            <button 
              className="px-8 py-3 rounded-lg font-medium transition-colors bg-primary text-primary-white"
            >
